...
var exec = function () {
    ...
    //GL1-8 搜尋列 click
    ga_submit_event('.btn-search-submit',"GL1-8"); // 遊客人數調查
    ...
    ga_mouse_scroll_in_event('.info-blk .duration',"GL2-14", function (_span) {
    ...
    ga_mouse_click_event('.fast-link-list a.link',"GL5-5");
    ...
    ga_mouse_click_event('.fast-link-list a.link',"GL5-6");
    

    //GL6-2  跳離網域   
    ga_mouse_click_event('a[target="_blank"]:not(.js-photoswipe-item)',"GL6-2");
    ga_mouse_click_event('a:not([target="_blank"])',"GL6-2");
